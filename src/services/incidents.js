...
class IncidentsService {
	constructor() {
		...
		//proxy for https://web.seattle.gov/sfd/realtime911/getRecsForDatePub.asp?action=Today&incDate=&rad1=des
		this._baseURL = 'https://fire.tim-bond.com/incidents?incDate=';
		//proxy for https://web.seattle.gov/sfd/realtime911/getRecsForDatePub.asp?rad1=des&incDate=
	}
